...
1. Создать в virtualbox виртуальную машину, подключить к ней скачаный диск и ещё 2 пустых диска (рекомендуемый размер - 4 Гб.)

1. Загрузиться. Войти как root (пароля нет).

1. В домашней дирректории root лежат несколько скриптов:

  1. "enter.sh" - этот скрипт нужен для изменения корневого каталога (входа) на папку будующей виртуальной машины. Используйте его для установки и обновления ПО, и других действий при подготовке виртуальных машин.
